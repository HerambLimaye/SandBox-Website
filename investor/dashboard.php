...
<div class="collapse navbar-collapse">  <!-- id="navigation"-->
 ...
 <h2 class="mb-4" style="text-align:center;padding-top:15px;">Company List</h2>
        <p>
  ...
  <div class="row no-gutters">
    ...
    <div class="col-md-8">
      <div class="card-body">
        ...
        <h4 class="card-text"><?php echo strip_tags($comp->cslogan); ?></h4>
        <h5 class="card-text"><?php echo strip_tags(substr($comp->cdesc, 0, 200).'...', "<br>"); ?></h5>
