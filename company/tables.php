      ...
      <nav class="navbar navbar-expand-lg navbar-absolute navbar-transparent">
        <div class="container-fluid">
          <div class="navbar-wrapper">
            ...
            <a class="navbar-brand" href="javascript:void(0)">Member List</a>
          </div>
                    ...
                    <?php foreach($emps as $emp) : ?>
                      <tr>
                        ...
                        <td class="text-center">
                          <?php 
                            echo 10000*(($emp->salary)/100)." ".💎;
                          ?>
                        </td>
                        <td class="text-center">
                          <a href="./delete?eid=<?php echo $emp->eid; ?>"><button name="remove" type="submit" class="btn btn-outline-primary">Remove</button></a>
                        </td>
                      </tr>
					<?php endforeach; ?>
